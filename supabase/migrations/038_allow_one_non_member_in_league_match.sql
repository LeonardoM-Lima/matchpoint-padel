...
begin
  ...
  if v_league_id is not null then
    ...
    if v_league_member_count < 3 then
      raise exception 'Ao menos 3 jogadores devem participar da liga';
    end if;
  end if;
  ...
  loop
    ...
    if v_league_id is not null then
      ...
      if v_league_points_before is not null then
